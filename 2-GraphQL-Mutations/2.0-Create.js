...
const typeDefs = gql`
  ...
  type Mutation {
    ...
    createUser(fullName: String!, age:Int!): User! # burada kullanıcıya eklenen User ı User tipinde göstereceğiz.
    createPost(title: String!, user_id: String!): Post!
  }
`;
  ...
  Mutation: {
    createUser: (parent, args) => {
      ...
      return users.length === ID
        ? addedUser
        : { id: ID, fullName: ` ${args.fullName} Eklenemedi` };
    },
